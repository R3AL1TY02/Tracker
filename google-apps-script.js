function doPost(e) {
  try {
    ...
    if (sheet.getLastRow() === 0) {
      const headers = ['Timestamp', 'First Name', 'Last Name', 'Date', 'Journey Name', 'Distance', 'Duration', 'Notes', 'Called Away'];
      ...
      [180, 130, 130, 120, 220, 100, 100, 400, 350].forEach((w, i) => sheet.setColumnWidth(i + 1, w));
    }
